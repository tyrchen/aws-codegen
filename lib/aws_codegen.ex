defmodule AWS.CodeGen do
  @elixir_services [
    ...
    {:json, "AWS.Cognito.IdentityProvider", "cognito-idp/2016-04-18",
    ...
    {:json, "AWS.Marketplace.CommerceAnalytics", "marketplacecommerceanalytics/2015-07-01",
     "marketplace_commerce_analytics.ex", []},
    {:json, "AWS.Marketplace.Metering", "meteringmarketplace/2016-01-14",
  ...
  @erlang_services [
    ...
    {:json, "aws_marketplace_commerce_analytics", "marketplacecommerceanalytics/2015-07-01",
     "aws_marketplace_commerce_analytics.erl", []},
    {:json, "aws_marketplace_metering", "meteringmarketplace/2016-01-14",
     "aws_marketplace_metering.erl", []},
  ...
  def generate(language, spec_base_path, template_base_path, output_base_path) do
    tasks =
      Enum.map(api_specs(language), fn {protocol, module_name, spec_path, output_filename,
                                        options} ->
  ...
  def generate_code(
    ...
    context =
      AWS.CodeGen.JSONService.load_context(language, module_name, api_spec_path, doc_spec_path)
  ...
  def generate_code(
    ...
    context =
      AWS.CodeGen.RestJSONService.load_context(
        language,
        module_name,
        api_spec_path,
        doc_spec_path,
